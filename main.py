while True:
    # Проверка на ввод и ввод данных
    try:
        k = int(input('Введите координату первой клетки по горизонтали: '))
        l = int(input('Введите координату первой клетки по вертикали: '))
        m = int(input('Введите координату второй клетки по горизонтали: '))
        n = int(input('Введите координату второй клетки по вертикали: '))
        ...
        4 -- Конь
        Ваш выбор: '''))
        if 0 > k > 8 or 0 > l > 8 or 0 > m > 8 or 0 > n > 8 or 0 > figure > 5:
